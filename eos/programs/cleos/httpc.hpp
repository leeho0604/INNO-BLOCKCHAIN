...
namespace eosio { namespace client { namespace http {
   ...
   const string chain_priv_func_base = "/v1/priv_chain";
   const string get_priv_block_header_state_func = chain_priv_func_base + "/get_block_header_state";
   const string get_priv_block_func = chain_priv_func_base + "/get_block";
   const string get_priv_info_func = chain_priv_func_base + "/get_info";
   const string get_priv_table_func = chain_priv_func_base + "/get_table_rows";
   const string get_priv_code_func = chain_priv_func_base + "/get_code";
   const string get_priv_account_func = chain_priv_func_base + "/get_account";
   const string priv_push_txn_func = chain_priv_func_base + "/push_transaction";
   const string get_priv_raw_code_and_abi_func = chain_priv_func_base + "/get_raw_code_and_abi";

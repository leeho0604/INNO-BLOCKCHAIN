...
namespace eosio { namespace chain {
   ...
   struct transaction_header {
      ...
      //    privDataBlock
      // };
      // using transaction_priv = EblockChain;
...
//      signed_transaction( signed_transaction&& ) = default;
      ...
      int __priv() {return static_cast<bool>(isPriv); }
   ...
   struct packed_transaction : fc::reflect_init {
      ...
      int priv() const { return static_cast<bool>(unpacked_trx.isPriv); }
      ...
      :signatures(t.signatures), compression(_compression), unpacked_trx(t)
      {
         ...
         //std::cout << "packed_transaction constructor : isPriv : " << t.isPriv << std::endl;
      }
...
//FC_REFLECT_ENUM(eosio::chain::transaction_header::EblockChain, (publicBlock)(contentsBlock)(accountsBlock)(privDataBlock))

FC_REFLECT_DERIVED( eosio::chain::transaction, (eosio::chain::transaction_header), (context_free_actions)(actions)(transaction_extensions)(isPriv) )

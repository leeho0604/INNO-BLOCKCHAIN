...
struct intrinsic_registrator {
   ...
   intrinsic_registrator(const char* mod, const char* name, const FuncSignature& sig, intrinsic_fn fn) {
      //std::cout << "           E O S I O           :    [wabt.hpp] [mod] [name] || " << mod << " : " << name << std::endl;
...
struct intrinsic_invoker_impl<Ret, std::tuple<>> {
   ...
   static const auto fn() {
      //std::cout << "intrinsic_registrator::intrinsic_fn fn() 13" << std::endl;
...
struct intrinsic_invoker_impl<void_type, std::tuple<>> {
   ...
   template<next_method_type Method>
   static const auto fn() {
      //std::cout << "intrinsic_registrator::intrinsic_fn fn() 12" << std::endl;
...
struct intrinsic_invoker_impl<Ret, std::tuple<Input, Inputs...>> {
   ...
   template<then_type Then>
   static const auto fn() {
      //std::cout << "intrinsic_registrator::intrinsic_fn fn() 11" << std::endl;
...
struct intrinsic_invoker_impl<Ret, std::tuple<array_ptr<T>, size_t, Inputs...>> {
   ...
   template<then_type Then>
   static const auto fn() {
      //std::cout << "intrinsic_registrator::intrinsic_fn fn() 10" << std::endl;
...
struct intrinsic_invoker_impl<Ret, std::tuple<null_terminated_ptr, Inputs...>> {
   ...
   template<then_type Then>
   static const auto fn() {
      //std::cout << "intrinsic_registrator::intrinsic_fn fn() 999" << std::endl;
...
struct intrinsic_invoker_impl<Ret, std::tuple<array_ptr<T>, array_ptr<U>, size_t, Inputs...>> {
   ...
   template<then_type Then>
   static const auto fn() {
      //std::cout << "intrinsic_registrator::intrinsic_fn fn() 888" << std::endl;
...
struct intrinsic_invoker_impl<Ret, std::tuple<array_ptr<char>, int, size_t>> {
   ...
   template<then_type Then>
   static const auto fn() {
      //std::cout << "intrinsic_registrator::intrinsic_fn fn() 777" << std::endl;
...
struct intrinsic_invoker_impl<Ret, std::tuple<T *, Inputs...>> {
   ...
   template<then_type Then>
   static const auto fn() {
      //std::cout << "intrinsic_registrator::intrinsic_fn fn() 666" << std::endl;
...
struct intrinsic_invoker_impl<Ret, std::tuple<const name&, Inputs...>> {
   ...
   template<then_type Then>
   static const auto fn() {
      //std::cout << "intrinsic_registrator::intrinsic_fn fn() 555" << std::endl;
...
struct intrinsic_invoker_impl<Ret, std::tuple<const fc::time_point_sec&, Inputs...>> {
   ...
   template<then_type Then>
   static const auto fn() {
      //std::cout << "intrinsic_registrator::intrinsic_fn fn() 444" << std::endl;
...
struct intrinsic_invoker_impl<Ret, std::tuple<T &, Inputs...>> {
   ...
   template<then_type Then>
   static const auto fn() {
      //std::cout << "intrinsic_registrator::intrinsic_fn fn() 333" << std::endl;
...
struct intrinsic_function_invoker {
   ...
   static const intrinsic_registrator::intrinsic_fn fn() {
      //std::cout << "intrinsic_registrator::intrinsic_fn fn() 111" << std::endl;
      //std::cout << "intrinsic_registrator::intrinsic_fn fn() 111 | Method : " << typeid(decltype(Method)).name() << std::endl;
...
struct intrinsic_function_invoker<void, MethodSig, Cls, Params...> {
   ...
   template<MethodSig Method>
   static const intrinsic_registrator::intrinsic_fn fn() {
      //std::cout << "intrinsic_registrator::intrinsic_fn fn() 222" << std::endl;
      //std::cout << "intrinsic_registrator::intrinsic_fn fn() 222 | Method : " << typeid(decltype(Method)).name() << std::endl;
      return impl::template fn<wrapper<Method>>();
   }

...
const static auto default_priv_blocks_dir_name     = "priv_blocks";
const static auto priv_reversible_blocks_dir_name  = "priv_reversible";
...
const static auto sss_filename                     = "sss.dat";
const static auto default_priv_state_dir_name      = "priv_state";
const static auto priv_forkdb_filename             = "priv_forkdb.dat";
...
const static uint32_t   default_max_block_cpu_usage                 = 200'000'000; /// max block cpu usage in microseconds
...
const static eosio::chain::priv_wasm_interface::vm_type priv_default_wasm_runtime = eosio::chain::priv_wasm_interface::vm_type::wabt;

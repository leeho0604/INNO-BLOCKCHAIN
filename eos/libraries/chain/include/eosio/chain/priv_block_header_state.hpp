...
struct priv_block_header_state {
    ...
    priv_block_header_state   next( const priv_signed_block_header& h, bool trust = false )const;
    priv_block_header_state   generate_next( block_timestamp_type when )const;
    ...
    producer_key         get_scheduled_producer_name()const;
    bool                 bp_check(account_name& name)const;
    /*
...
FC_REFLECT( eosio::chain::priv_block_header_state,

...
namespace eosio { namespace chain {
   ...
   struct priv_signed_block_header : public block_header
   {
      signature_type    producer_signature;
      fc::sha256        keccakHash;
   };
...
FC_REFLECT_DERIVED(eosio::chain::priv_signed_block_header, (eosio::chain::block_header), (producer_signature))

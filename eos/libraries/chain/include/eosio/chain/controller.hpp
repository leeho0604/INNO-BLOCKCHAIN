   ...
   class controller {
      public:
         ...
         struct config {
            ...
            path                     priv_blocks_dir        =  chain::config::default_priv_blocks_dir_name;
            path                     priv_state_dir         =  chain::config::default_priv_state_dir_name;
         ...
         const chainbase::database& priv_db() const;
      ...
      private:
         ...
         chainbase::database& priv_mutable_db() const;

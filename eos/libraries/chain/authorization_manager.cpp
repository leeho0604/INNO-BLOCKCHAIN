...
namespace eosio { namespace chain {
   ...
   {
      std::cout << "           E O S I O           :    [Start 1] [authorization_manager] [check_authorization] [provided_keys] | " << fc::json::to_string(provided_keys) << std::endl;
      ...
      for( const auto& act : actions ) {
         ...
         std::cout << "           E O S I O           :    [Start 2] [authorization_manager] [check_authorization] [provided_keys] | " << fc::json::to_string(provided_keys) << std::endl;

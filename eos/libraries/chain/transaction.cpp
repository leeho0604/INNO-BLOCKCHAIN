...
bool transaction_header::verify_reference_block( const block_id_type& reference_block )const {
   std::cout << " verify_reference_block [ db's block_number ] :" << (decltype(ref_block_num))fc::endian_reverse_u32(reference_block._hash[0]) 
               << "| trx's ref_block_num : " << ref_block_num << std::endl;
   std::cout << " verify_reference_block [ db's ref_block_prefix ] :" << (decltype(ref_block_prefix))reference_block._hash[1]
             << "| trx's ref_block_num : " << ref_block_prefix << std::endl;

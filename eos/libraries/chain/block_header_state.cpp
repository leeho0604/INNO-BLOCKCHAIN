...
namespace eosio { namespace chain {
   ...
   producer_key block_header_state::get_scheduled_producer_name()const{
   ...
   bool block_header_state::bp_check(account_name& name)const{
      for(auto& a : active_schedule.producers)
         if(a.producer_name == name){
            std::cout << "           E O S I O           :    [Start] [block_header_state] [bp_check] [same bp]  " << std::endl;
            return true;
         }
         std::cout << "           E O S I O           :    [Start] [block_header_state] [bp_check] [not the same]  " << std::endl;
         return false;
   }

...
wabt::Result BinaryReaderInterp::OnType(Index index,
  ...
  //std::cout << "OnType : sigs_.size() " << env_->GetFuncSignatureCount() << std::endl;
...
wabt::Result BinaryReaderInterp::OnImportFunc(Index import_index,
  ...
  //std::cout << "OnImportFunc : Sig, Func, export Index : " << import->sig_index << " " << func->sig_index << " " << export_->index << std::endl; 
...
wabt::Result BinaryReaderInterp::OnFunction(Index index, Index sig_index) {
  ...
  //std::cout << "OnFunction : sig_index : " << sig_index << std::endl;
  //std::cout << "OnFunciton : TR - sig_index : " << TranslateSigIndexToEnv(sig_index) << std::endl;
  return wabt::Result::Ok;
}
...
wabt::Result BinaryReaderInterp::OnTable(Index index,
  ...
  //std::cout << "OnTable : table_index : " << table_index << std::endl;
  return wabt::Result::Ok;
}
...
wabt::Result BinaryReaderInterp::OnExport(Index index,
  ...
  //std::cout << "OnExport : name , item_index : " << name.to_string() << " : " << item_index << std::endl;
...
wabt::Result BinaryReaderInterp::BeginFunctionBody(Index index) {
  ...
  //std::cout << "BeginFunctionBody : kInvalidIstreamOffset : " << kInvalidIstreamOffset << std::endl;
...
wabt::Result ReadBinaryInterp(Environment* env,
  ...
  //std::cout << " Mark funcs_size : " << mark.funcs_size << std::endl;

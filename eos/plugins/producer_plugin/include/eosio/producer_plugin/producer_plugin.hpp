...
#include <../../priv_chain_plugin/include/eosio/priv_chain_plugin/priv_chain_plugin.hpp>
...
public:
   APPBASE_PLUGIN_REQUIRES((chain_plugin)(priv_chain_plugin)(http_client_plugin))
   ...
   chain::public_key_type get_producer_key() const;
   ...
   account_name get_producer_name();

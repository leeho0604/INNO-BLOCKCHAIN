...
class read_only {
   const chain::priv_controller& db;
...
public:
   ...
   read_only(const chain::priv_controller& db, const fc::microseconds& abi_serializer_max_time)
   ...
   get_table_rows_result get_table_rows_priv(const get_table_rows_params &params) const;
   static uint64_t get_table_index_name(const read_only::get_table_rows_params &p, bool &primary);

   template <typename IndexType>
   read_only::get_table_rows_result priv_get_table_rows_ex(const read_only::get_table_rows_params &p, const abi_def &abi) const
   {
      ...
      //std::cout << "           E O S I O           :    [Start] [chain_plugin] [get_table_rows_ex] [t_id] " << fc::json::to_pretty_string(*t_id) << std::endl;
      ...
      if (t_id != nullptr)
      {
         ...
         auto walk_table_row_range = [&](auto itr, auto end_itr) {
            ...
            for (unsigned int count = 0; cur_time <= end_time && count < p.limit && itr != end_itr; ++count, ++itr, cur_time = fc::time_point::now())
            {
               ...
               if (p.json)
               {
                  std::cout << "wook : chain_plugin.hpp : data 1 " << std::endl;
   ...
   read_only::get_table_rows_result priv_get_table_rows_by_seckey(const read_only::get_table_rows_params &p, const abi_def &abi, ConvFn conv) const
   {
      read_only::get_table_rows_result result;
      const auto &d = db.db();

      std::cerr << "daesony : chain_plugin get_table_rows_by_seckey() : p.scope : " << p.scope << std::endl;
      ...
      std::cerr << "daesony : chain_plugin get_table_rows_by_seckey() : table_with_index : " << table_with_index << std::endl;
...
class read_write {
   chain::priv_controller& db;
   const fc::microseconds abi_serializer_max_time;
public:
   read_write(chain::priv_controller& db, const fc::microseconds& abi_serializer_max_time);
   void validate() const;

   using push_block_params = chain::priv_signed_block;
...
template <const char *key_type, const char *encoding = priv_chain_apis::dec>
struct keytype_converter;

template <>
struct keytype_converter<priv_chain_apis::sha256, priv_chain_apis::hex>
{
...
template <>
struct keytype_converter<priv_chain_apis::ripemd160, priv_chain_apis::hex>
{
...
template <>
struct keytype_converter<priv_chain_apis::i256>
{
...
class priv_chain_plugin : public plugin<priv_chain_plugin> {
public:
   APPBASE_PLUGIN_REQUIRES()

   priv_chain_plugin();
   virtual ~priv_chain_plugin();
   ...
   priv_chain_apis::read_only get_read_only_api() const { return priv_chain_apis::read_only(chain(), get_abi_serializer_max_time()); }
   priv_chain_apis::read_write get_read_write_api() { return priv_chain_apis::read_write(chain(), get_abi_serializer_max_time()); }

   void accept_block( const chain::priv_signed_block_ptr& block );
   ...
   chain::priv_controller& chain();
   // Only call this after plugin_initialize()!
   const chain::priv_controller& chain() const;
...
private:
   ...
   unique_ptr<class priv_chain_plugin_impl> my;
};

}

FC_REFLECT( eosio::priv_chain_apis::permission, (perm_name)(parent)(required_auth) )
FC_REFLECT(eosio::priv_chain_apis::empty, )

FC_REFLECT(eosio::priv_chain_apis::read_only::get_block_params, (block_num_or_id))
FC_REFLECT(eosio::priv_chain_apis::read_only::get_block_header_state_params, (block_num_or_id))
FC_REFLECT( eosio::priv_chain_apis::read_write::push_transaction_results, (transaction_id)(processed) )
FC_REFLECT(eosio::priv_chain_apis::read_only::get_info_results,
...
FC_REFLECT(eosio::priv_chain_apis::read_only::get_abi_results, (account_name)(abi))
FC_REFLECT(eosio::priv_chain_apis::read_only::get_abi_params, (account_name))
FC_REFLECT(eosio::priv_chain_apis::read_only::get_code_results, (account_name)(code_hash)(wast)(wasm)(abi))
FC_REFLECT(eosio::priv_chain_apis::read_only::get_code_params, (account_name)(code_as_wasm))
FC_REFLECT(eosio::priv_chain_apis::read_only::get_raw_code_and_abi_params, (account_name))
FC_REFLECT(eosio::priv_chain_apis::read_only::get_raw_code_and_abi_results, (account_name)(wasm)(abi))
FC_REFLECT( eosio::priv_chain_apis::read_only::get_account_results,
            (account_name)(head_block_num)(head_block_time)(privileged)(last_code_update)(created)
            (core_liquid_balance)(ram_quota)(net_weight)(cpu_weight)(net_limit)(cpu_limit)(ram_usage)(permissions)
            (total_resources)(self_delegated_bandwidth)(refund_request)(voter_info) )
FC_REFLECT(eosio::priv_chain_apis::read_only::get_account_params, (account_name)(expected_core_symbol))
FC_REFLECT(eosio::priv_chain_apis::read_only::get_table_rows_params, (json)(code)(scope)(table)(table_key)(lower_bound)(upper_bound)(limit)(key_type)(index_position)(encode_type)(reverse)(show_payer))
FC_REFLECT(eosio::priv_chain_apis::read_only::get_table_rows_result, (rows)(more));

/*


FC_REFLECT( eosio::priv_chain_apis::read_only::get_table_by_scope_params, (code)(table)(lower_bound)(upper_bound)(limit)(reverse) )
FC_REFLECT( eosio::priv_chain_apis::read_only::get_table_by_scope_result_row, (code)(scope)(table)(payer)(count));
FC_REFLECT( eosio::priv_chain_apis::read_only::get_table_by_scope_result, (rows)(more) );

FC_REFLECT( eosio::priv_chain_apis::read_only::get_currency_balance_params, (code)(account)(symbol));
FC_REFLECT( eosio::priv_chain_apis::read_only::get_currency_stats_params, (code)(symbol));
FC_REFLECT( eosio::priv_chain_apis::read_only::get_currency_stats_result, (supply)(max_supply)(issuer));

FC_REFLECT( eosio::priv_chain_apis::read_only::get_producers_params, (json)(lower_bound)(limit) )
FC_REFLECT( eosio::priv_chain_apis::read_only::get_producers_result, (rows)(total_producer_vote_weight)(more) );

FC_REFLECT_EMPTY( eosio::priv_chain_apis::read_only::get_producer_schedule_params )
FC_REFLECT( eosio::priv_chain_apis::read_only::get_producer_schedule_result, (active)(pending)(proposed) );

FC_REFLECT( eosio::priv_chain_apis::read_only::get_scheduled_transactions_params, (json)(lower_bound)(limit) )
FC_REFLECT( eosio::priv_chain_apis::read_only::get_scheduled_transactions_result, (transactions)(more) );
...
FC_REFLECT( eosio::priv_chain_apis::read_only::get_code_hash_results, (account_name)(code_hash) )
FC_REFLECT( eosio::priv_chain_apis::read_only::get_abi_results, (account_name)(abi) )
FC_REFLECT( eosio::priv_chain_apis::read_only::get_account_params, (account_name)(expected_core_symbol) )

FC_REFLECT( eosio::priv_chain_apis::read_only::get_code_hash_params, (account_name) )

FC_REFLECT( eosio::priv_chain_apis::read_only::get_raw_abi_params, (account_name)(abi_hash) )
FC_REFLECT( eosio::priv_chain_apis::read_only::get_raw_abi_results, (account_name)(code_hash)(abi_hash)(abi) )
FC_REFLECT( eosio::priv_chain_apis::read_only::producer_info, (producer_name) )
FC_REFLECT( eosio::priv_chain_apis::read_only::abi_json_to_bin_params, (code)(action)(args) )
FC_REFLECT( eosio::priv_chain_apis::read_only::abi_json_to_bin_result, (binargs) )
FC_REFLECT( eosio::priv_chain_apis::read_only::abi_bin_to_json_params, (code)(action)(binargs) )
FC_REFLECT( eosio::priv_chain_apis::read_only::abi_bin_to_json_result, (args) )
FC_REFLECT( eosio::priv_chain_apis::read_only::get_required_keys_params, (transaction)(available_keys) )
FC_REFLECT( eosio::priv_chain_apis::read_only::get_required_keys_result, (required_keys) )
*/
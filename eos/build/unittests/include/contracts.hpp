...
#define MAKE_READ_WASM_ABI(CN,C, D) \
   static std::vector<uint8_t> CN ## _wasm() { return read_wasm("/home/ghlee/INNO-RTFDocs/eos/build/unittests/" #D "/" #C "/" #C ".wasm"); } \
   static std::vector<char> CN ## _abi() { return read_abi("/home/ghlee/INNO-RTFDocs/eos/build/unittests/" #D "/" #C "/" #C ".abi"); }
